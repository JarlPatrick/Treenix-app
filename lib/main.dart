...
String? clientId =
    '530424340620-8ir5umpjme3ubn9nhn1ehnrunps9m0pe.apps.googleusercontent.com';

/// To run this example, replace this value with your server client ID, and/or
/// update the relevant configuration files, as described in the README.
String? serverClientId =
    '530424340620-n030jitnuloasef7g2uld0m8fnhi2jn8.apps.googleusercontent.com';
  ...
  String _errorMessageFromSignInException(GoogleSignInException e) {
    ...
    return switch (e.code) {
      GoogleSignInExceptionCode.canceled =>
        'Sign in canceled ${e.code}: ${e.description}',
